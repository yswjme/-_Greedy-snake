...
const unsigned char chinese[10][32]={
	{0x01,0x00,0x41,0x01,0x41,0x02,0x41,0x0C,0x7F,0xF0,0x41,0x00,0x41,0x00,0x41,0x00,0x41,0x00,0x41,0x00,0x7F,0xFF,0x41,0x00,0x41,0x00,0x41,0x00,0x01,0x00,0x00,0x00},/*"开",0*/

	{0x08,0x02,0x08,0x44,0x0F,0xA8,0xF8,0x10,0x08,0x68,0x0F,0x84,0x00,0x00,0x02,0x00,0x07,0x7F,0x1A,0x42,0xE2,0x42,0x02,0x42,0x0A,0x42,0x06,0x7F,0x03,0x00,0x00,0x00},/*"始",1*/

	{0x08,0x20,0x06,0x20,0x40,0x7E,0x31,0x81,0x00,0x02,0x10,0x0C,0x9F,0xF0,0x72,0x02,0x13,0xFE,0x04,0x00,0x1A,0x22,0xF2,0x21,0x12,0xFE,0x13,0x20,0x10,0x20,0x00,0x00},/*"游",2*/

	{0x00,0x00,0x10,0x04,0x12,0x08,0x11,0x30,0x10,0xC0,0x13,0x20,0x1C,0x18,0x02,0x01,0x02,0x02,0x02,0x04,0xFF,0xE8,0x04,0x18,0x44,0x64,0x35,0x82,0x04,0x0F,0x00,0x00},/*"戏",3*/
		
	{0x00,0x04,0x1F,0xC6,0x10,0x84,0xFF,0xF8,0x10,0x88,0x1F,0x98,0x04,0x0C,0x18,0x00,0x13,0xFC,0x10,0x22,0x90,0x42,0x70,0x82,0x11,0x02,0x14,0x02,0x18,0x1E,0x00,0x00},/*"蛇",4*/
	...
	{0x00,0x02,0x27,0xFC,0x34,0x01,0xAC,0x91,0x65,0x22,0x2E,0x44,0x34,0x88,0x24,0x10,0x40,0x01,0x4F,0xF2,0x58,0x0C,0x6B,0xF0,0x48,0x08,0x4F,0xF4,0x40,0x03,0x00,0x00},/*"颜",6*/

	{0x04,0x00,0x08,0x00,0x17,0xFC,0x24,0x42,0xE4,0x42,0x24,0x42,0x24,0x42,0x27,0xC2,0x24,0x42,0x2C,0x42,0x34,0x42,0x04,0x42,0x07,0xC2,0x00,0x02,0x00,0x1E,0x00,0x00},/*"色",7*/
		
	{0x02,0x00,0x02,0x02,0x42,0x04,0x33,0xF8,0x00,0x04,0x20,0x12,0x2F,0x22,0x29,0x42,0x29,0x82,0xFF,0xFA,0x29,0x82,0x29,0x42,0x2F,0x22,0x20,0x12,0x00,0x02,0x00,0x00},/*"速",8*/

	{0x00,0x02,0x00,0x0C,0x3F,0xF1,0x24,0x01,0x24,0x21,0x24,0x32,0x3F,0xAA,0xA4,0xA4,0x64,0xA4,0x24,0xA4,0x3F,0xAA,0x24,0x32,0x24,0x01,0x24,0x01,0x20,0x01,0x00,0x00}/*"度",9*/
};
//LCD的画笔颜色和背景色	   
...
//圆形涂色函数
void circle_full_color(uint16_t x0,uint16_t y0,uint8_t r,uint16_t color)
{
	uint8_t i=0;
	POINT_COLOR=color;
	for(;i<r;i++)
...
//显示中文16号
void Chinese_Show_one(uint8_t x, uint16_t y, uint8_t num, uint8_t size, uint8_t mode)
{
    uint8_t temp,t,t1;
    uint16_t y0=y;
...
源数组
*/
void LCD_Draw_Picture(uint16_t x,uint16_t y,uint16_t col,uint16_t row,unsigned short *pic)	    //画图
{
	uint16_t m,h;
